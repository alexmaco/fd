...
mod user_parsing {
    ...
    owner_tests! {
        ...
        uid_negate: "!5"    => Ok(UserFilter { uid: NotEq(5), gid: Ignore    }),
        both_negate:"!4:!3" => Ok(UserFilter { uid: NotEq(4), gid: NotEq(3)  }),
        uid_not_gid:"6:!8"  => Ok(UserFilter { uid: Equal(6), gid: NotEq(8)  }),
    }
}
